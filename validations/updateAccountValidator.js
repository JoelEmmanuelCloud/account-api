...
const updateAccountJoiSchema = Joi.object({
    firstName: Joi.string()
        ...
        .messages({
            ...
            'string.regex':
                'First name should contain only uppercase or lowercase letters.',
        }),
    lastName: Joi.string()
        .trim()
        .min(2)
        ...
        .messages({
            ...
            'string.regex':
                'Last name should contain only uppercase or lowercase letters.',
        }),
    ...
    zipCode: Joi.string().trim().allow('').messages({
    ...
    city: Joi.string()
        ...
        .messages({
            ...
            'string.regex':
                'City should contain only uppercase or lowercase letters.',
        }),
    country: Joi.string()
        .trim()
        .max(100)
        ...
        .messages({
            ...
            'string.regex':
                'Country should contain only uppercase or lowercase letters.',
        }),
